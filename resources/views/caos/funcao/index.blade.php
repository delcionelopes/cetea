...
<div class="container-fluid py-5">   
    ...
    <form action="{{route('ceteaadmin.funcao.index')}}" class="form-search" method="GET">
        <div class="col-sm-12">
...
$(document).ready(function(){        
        ...
        $(document).on('click','.delete_funcao_btn',function(e){   ///inicio delete
            ...
            Swal.fire({
             ...
             if(result.isConfirmed){             
                $.ajax({
                    url: '/ceteaadmin/funcao/delete-funcao/'+id,
                    type: 'POST',
                    dataType: 'json',
                    data:{
                        'id': id,
        ...
        $(document).on('click','.edit_funcao',function(e){  
            ...
            $.ajax({ 
                type: 'GET',             
                dataType: 'json',                                    
                url: '/ceteaadmin/funcao/edit-funcao/'+id,                                
                success: function(response){           
                    if(response.status==200){                           
        ...
        $(document).on('click','.update_funcao',function(e){ //inicio da atualização de registro
            ...
            $.ajax({     
                ...
                data: data,
                dataType: 'json',    
                url: '/ceteaadmin/funcao/update-funcao/'+id,         
                success: function(response){                                                    
        ...
        $(document).on('click','.add_funcao',function(e){ //início da adição de Registro
            ...
            $.ajax({
                type: 'POST',
                url: '/ceteaadmin/funcao/store-funcao',
                data: data,
                dataType: 'json',
                success: function(response){
                    if(response.status==400){
